<template>
  <div class="space-y-6 pb-8">
    ...
    <nav class="flex items-center space-x-2 text-sm" aria-label="Breadcrumb">
      ...
      <span :class="isDarkMode ? 'text-gray-500' : 'text-gray-400'">/</span>
      <span :class="isDarkMode ? 'text-gray-300' : 'text-gray-700'">Add Vendor</span>
    </nav>
    ...
    <div class="flex items-center gap-4">
      ...
      <div>
        <h1 class="text-2xl md:text-3xl font-bold" :class="isDarkMode ? 'text-white' : 'text-gray-900'">Create New Vendor</h1>
        <p class="text-sm" :class="isDarkMode ? 'text-gray-400' : 'text-gray-600'">Add a new vendor to your system with their own account</p>
      </div>
    </div>
    ...
    <div :class="[
      ...
      <form @submit.prevent="createVendor" enctype="multipart/form-data">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="col-span-2">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              ...
              <!-- Logo Info -->
              <div class="flex-1">
                <div v-if="logoPreview" class="flex flex-col">
                  <div class="flex flex-wrap items-center gap-3">
                    <span class="text-sm font-medium" :class="isDarkMode ? 'text-gray-300' : 'text-gray-700'">{{ logoFileName }}</span>
                    <span class="text-xs" :class="isDarkMode ? 'text-gray-400' : 'text-gray-500'">({{ logoFileSize }})</span>
                  </div>
...
const createVendor = async () => {
  ...
  try {
    ...
    router.push(`/admin/vendors/${response.data.id}`);
  } catch (error) {
