        ...
        <table class="w-full">
          <thead :class="isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider" :class="isDarkMode ? 'text-gray-400' : 'text-gray-500'">Cost Price</th>
              <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider" :class="isDarkMode ? 'text-gray-400' : 'text-gray-500'">Sale Price</th>
          ...
          <tbody class="divide-y" :class="isDarkMode ? 'divide-gray-700' : 'divide-gray-200'">
            ...
            <tr v-for="product in filteredProducts" :key="product.id" class="transition-colors" :class="isDarkMode ? 'hover:bg-gray-700/50' : 'hover:bg-gray-50'">
              ...
              <td class="px-6 py-4 text-sm font-semibold" :class="isDarkMode ? 'text-white' : 'text-gray-900'">${{ parseFloat(product.sale_price).toFixed(2) }}</td>
              <td class="px-6 py-4">
              ...
              <td class="px-6 py-4">
                <div class="flex items-center justify-end gap-2">
                  <router-link :to="`/vendor/products/${product.id}`" 
                  ...
                  <router-link :to="`/vendor/products/${product.id}/edit`" 
                    class="p-1.5 rounded-lg transition-colors"
      ...
      <div class="md:hidden divide-y" :class="isDarkMode ? 'divide-gray-700' : 'divide-gray-100'">
        ...
        <div v-for="product in filteredProducts" :key="product.id" class="p-4 space-y-3 transition-colors" :class="isDarkMode ? 'hover:bg-gray-700/50' : 'hover:bg-gray-50'">
          ...
          <div class="flex items-start justify-between">
            ...
            <span class="text-sm font-semibold" :class="isDarkMode ? 'text-white' : 'text-gray-900'">${{ parseFloat(product.sale_price).toFixed(2) }}</span>
          </div>
...
const confirmDelete = async () => {
  ...
  deleting.value = true;
  try {
    await axios.delete(`/api/vendor/products/${productToDelete.value.id}`);
